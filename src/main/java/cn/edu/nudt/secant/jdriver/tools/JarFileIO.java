...
//			throw new RuntimeException("Attempting to create output JAR but file classname does not have .jar extension");
//		}
//		try {
...
//	}
	 ...
	 * 
	 * @param file The classname of the file.
